...
namespace WasteTrader.Measurements
{
    public static class MeasurementReader
    {
        ...
        {
            { UnitType.Mass, (long quantity, int prefixpower) => new Mass(quantity, prefixpower)},
            { UnitType.Length, (long quantity, int prefixpower) => new Length(quantity, prefixpower)},
            { UnitType.Area, (long quantity, int prefixpower) => new Area(quantity, prefixpower)},
            { UnitType.Volume, (long quantity, int prefixpower) => new Volume(quantity, prefixpower)}
        };
